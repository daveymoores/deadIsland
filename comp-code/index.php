...
<html>
<head>
	<!-- DEMO PURPOSES FOR STYLING THE FORM BELOW -->
    <link href="http://twitter.github.com/bootstrap/assets/css/bootstrap.css" rel="stylesheet" type="text/css"><!-- END -->
    <title></title>
</head>
...
<form action="" method="post" class="form-horizontal">
        ...
        <div class="control-group">
            <div class="controls">
                <label class="checkbox"><input type="checkbox" name="console_xbox" value="1">Xbox 360</label>
            </div>

            <div class="controls">
                <label class="checkbox"><input type="checkbox" name="console_ps" value="1">Playstation 3</label>
            </div>
            
            <div class="controls">
                <label class="checkbox"><input type="checkbox" name="console_pc" value="1">PC</label>
            </div>
        </div>
        ...
        <div class="control-group">
            <div class="controls">
                ...
                <span class="help-block">I confirm that I am a UK resident over the age of 18 and have read and understood the terms and conditions</span>
            </div>
        </div>
        ...
        <div class="control-group">
            <div class="controls">
	            ...
	            <input type="submit" class="btn-primary btn" name="_submit">
            </div>
        </div>
    </form>  
</div> <!-- container -->
